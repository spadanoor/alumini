...
MySQL - 5.7.10-log : Database - alumini_data
*********************************************************************
*/
...
insert  into `alumni_details`(`id`,`name`,`pass`,`branch`,`yop`,`add1`,`mob`,`email`,`usn`) values (1,'ramesh','ramesh@1','Computer science','2015','FFDFGHGHGHHHHHHHHHHHHHH','9611181186','dhareppa.madari021@gmail.com','2BL13CS043');
...
insert  into `student_details`(`sid`,`s_name`,`s_pass`,`branch_name`,`year`,`s_address`,`mobile`,`email`,`usn`) values (1,'raju','raju1','Computer','3','vijayapur','9611181186','raju@gmail.com','2BL11CS021');
