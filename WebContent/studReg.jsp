...
<script type="text/javascript">
        ...
        function checkUser()
        {
            ...
            try
            {
             ...
             var url="bbvalid1.jsp?usn="+document.form1.usn.value;
...
Closing of Conetent
 ...
 <h2 class="text-center text-dark mt-5">Student Registration</h2><br></br>
 <form  id="form1" name="form1" method="post" action="do?MOD=STUD&Action=Reg" onsubmit="return  validate();">
   <div class="form-row">
    <div class="form-group col-md-6">
      <label for="sname">Name</label>
      <input name="sname" type="text" id="sname" class="form-control"  placeholder="Enter Your Name" required>
    </div>
    <div class="form-group col-md-6">
